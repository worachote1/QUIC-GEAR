            ...
            <div className="flex-col mt-6 mr-4 md:mr-24 lg:mr-16">
              ...
              <div className="mt-12 lg:mt-6">
                <Link to="/auction_create/">
                  <button className="border border-red-500 bg-white text-red-500 font-bold px-4 py-2 rounded-full hover:bg-red-500 hover:text-white transition duration-300 your-custom-class">
