  ...
  return (
    ...
    <div className='bg-white lg:w-[210px] md:w-[210px] w-[170px] rounded-md p-4 my-2 mx-2 md:mx-4 relative shadow-md transition duration-300'>
      ...
      <div className='flex flex-col'>
        ...
        <p className='text-lg font-medium text-right h-12'><span className='text-gray-500'> {displayCountDownDate(timeRemaining.days, timeRemaining.hours, timeRemaining.minutes, timeRemaining.seconds)} </span></p>
      </div>
