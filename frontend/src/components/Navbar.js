      ...
      <nav className="flex flex-col md:flex-row items-center p-4 shadow-md">
        ...
        <div className="w-full md:w-1/2 mt-4 md:mt-0 text-center md:text-right hidden lg:block">
          <div className="md:ml-auto flex justify-center md:justify-end">
            <button
              className="btn border-white text-black rounded-full hover:bg-red-700/30 mr-2"
              id="auction_btn"
            >
              <i
            ...
            <button
              className="btn bg-red-700/90 text-white hover:bg-red-600 hover:shadow-lg px-2 py-1 text-md lg:px-4 lg:py-2 lg:text-base"
              id="login_btn"
            >
              ลงชื่อเข้าใช้
            </button>
